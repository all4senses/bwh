...
// Ookla speed test page original content. -------------------------------------------------------------------------------
  ...
  $path_to_custom_js = drupal_get_path('module', 'bwh_pages') . '/js/';
  drupal_add_js($path_to_custom_js . 'bwh_speedtest_page.js');
     ...
     <div class="share">
       <div class="main">
              ...
              <?php
                ...
                $url = 'http://bestwebhosting.ca' . $_SERVER['REQUEST_URI']; 
                echo bwh_blocks_getSocialiteButtons($url, $share_title); 
