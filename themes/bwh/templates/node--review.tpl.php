...
<?php endif; ?>
  ...
  <div class="main-content"  xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review">
        ...
        <div class="content"<?php print $content_attributes; ?>>
          ...
          <div class="bwh_votes">
            <?php echo '<div class="caption"><span>' , t('User\'s Rating') , ':</span> <span property="v:rating">' , (empty($node->field_r_rating_overall['und'][0]['value']) ? $node->field_r_rating_overall[0]['value'] : $node->field_r_rating_overall['und'][0]['value']), '</span>' /* render($content['bwh_rating_overall'])*/ , '<div class="bottom-clear"></div></div>' , render($content['bwh_ratings']); ?>
            <div class="rate-other">
              ...
              <?php endif; ?>
              <div class="text rec"><?php echo '<span class="title">Recommend: </span><span class="data">' . $node->bwh_recommend . '</span>'?></div>
            </div>
          </div>
...
//                  . '</div>'; 
                  ...
                  echo '<div class="rlinks">';
                      ...
                      if($page || $full_title) {
                        ...
                        . ( !$provider_url ? '' : bwh_misc_getTrackingUrl('<span class="review-provider">Visit <span property="v:itemreviewed">' . $provider_name . '</span></span>', NULL, $node->field_ref_provider['und'][0]['target_id']));
                      }
                      else {
                        echo !$provider_url ? '' : bwh_misc_getTrackingUrl('Visit <span class="review-provider" property="v:itemreviewed">' . $provider_name . '</span>', NULL, $node->field_ref_provider['und'][0]['target_id']);
                      }
